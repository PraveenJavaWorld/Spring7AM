...
public class CustomerController {
	...
	//initBinder to register Custome Property Editor
	@InitBinder
	public void myInitBinder(ServletRequestDataBinder binder) {
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
		//makes the binder obj to use CustomDateEditor to convert giver String value(yyyy-MM-dd) into java.util.Date class obj
